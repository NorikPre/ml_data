...
def train_model_with_mlflow(params, X_train, y_train, X_test, y_test):
...
hyperparameters = {'n_estimators': 2, 'max_depth': 1000, 'min_samples_leaf': 1},


# Modelle mit verschiedenen Hyperparametern trainieren
for params in hyperparameters:
    train_model_with_mlflow(params, X_train, y_train, X_test, y_test)
...
experiment = mlflow.get_experiment_by_name("Fuel Consumption Prediction 1")
